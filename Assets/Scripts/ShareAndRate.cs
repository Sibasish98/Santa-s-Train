...
public class ShareAndRate : MonoBehaviour {
	...
	string subject = "Check out this Christmas game";
	string body = "https://play.google.com/store/apps/details?id=com.snowflakes.santastrain";
	#if UNITY_IPHONE
	...
	{
		#if UNITY_ANDROID
		Application.OpenURL("https://play.google.com/store/apps/details?id=com.snowflakes.santastrain");
		#elif UNITY_IPHONE
